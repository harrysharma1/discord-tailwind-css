...
function Sidebar() {
  ...
  return (
    <div className="fixed top-0 left-0 h-screen w-16 m-0 flex flex-col dark:bg-gray-900 bg-white text-white shadow-lg">
        <SidebarIcon icon={<FaIcons.FaGithub size={28} onClick={event=>window.location.href="https://github.com/harrysharma1"}/>} text="My Github"/>
        <Divider/>
        <SidebarIcon icon={<FaIcons.FaLinkedin size={32} onClick={event=>window.location.href="https://www.linkedin.com/in/harry-sharma-567b21225/"}/>}text="My LinkedIn"/>
